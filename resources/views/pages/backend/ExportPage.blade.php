...
<div x-data="heroModal()" class="p-6 space-y-10">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-white">Hero Section</h1>
    </div>
    ...
    <div x-show="show"
        ...
        <div class="bg-white text-black w-[700px] p-6 rounded-xl max-h-[90vh] overflow-auto">
            ...
            <h2 class="text-xl font-bold mb-5" x-text="modalTitle"></h2>

            {{-- ✅ NORMAL LARAVEL FORM (NO FETCH) --}}
            <form :action="actionUrl"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <input type="text" name="btn_primary_link"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <input type="text" name="btn_secondary_link"
